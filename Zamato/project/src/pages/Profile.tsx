...
import { User, Mail, Phone, MapPin, CreditCard, Heart, Package, Bell, LogOut, ChevronRight, Camera } from 'lucide-react';
...
export default function Profile({data}: {data: any[]}) {
  const [profile] = useState(() => {
    ...
    const phone = typeof user?.mobile === 'string' && user.mobile.trim()
      ? user.mobile
      : '+91 98765 43210';
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        {/* Logout */}
        <button className="w-full flex items-center justify-center gap-2 bg-white text-red-500 py-4 rounded-2xl shadow-sm hover:bg-red-50 transition-colors font-semibold">
